  ...
  public static void main(String[] args) throws Exception {
    RatpackServer.start(s -> s
        ...
        .handlers(chain -> chain
            ...
            .path("injected", MyHandler.class) // Map to a dependency injected handle
            .path("observable", FixedValueObservableHandler.class)
            .path("httpclient", DownstreamHttpClientHandler.class)
            .path("hystrixhttpclient", DownstreamHttpClientHystrixHandler.class)
            .path("cassandra", DownstreamCassandraHandler.class)
